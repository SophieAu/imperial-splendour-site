...
![Austrian army unit icons](static/austria_units_1.2.png "Austrian army unit icons")

</center>

And the Spanish (without colonial units, note that the rooster is in an early state, models and texture can change with the next updates):

<center>

![Spanish unit roster icons](static/spanish_units_1.2.png "Spanish unit roster")

</center>

We also wrote tons of descriptions. In total descriptions numbering around 50.000 words were added. Furthermore, hundreds of new generic portraits have been added. 
...
The navies got a huge rework. Every major naval faction now has specific new ships and designs for you to construct and rule the waves. There's so much to say about each individual nation that the best might be too left it to you to explore.
