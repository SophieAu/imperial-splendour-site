...
const Footer = () => (
  <footer className="footer">
    <div className="footer-credits">
      ...
      {` and `}
      <Link to="https://github.com/QuintusHortensiusHortalus">Malte Lippmann</Link>
    </div>
...
const ModDB = () => (
  <ImageLink to="https://www.moddb.com/mods/imperial-splendour" title="Imperial Splendour on ModDB">
    <img src="https://button.moddb.com/popularity/medium/mods/20800.png" alt="" />
  </ImageLink>
);
...
const Twitter = () => (
  <ImageLink to="https://twitter.com/splendourteam" title="Imperial Splendour on Twitter">
    <svg viewBox="0 0 24 24" role="img">
