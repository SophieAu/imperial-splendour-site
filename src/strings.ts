...
const infoBoxes: InfoBox[] = [
  {
    image: require('../assets/img/index/info_blackwatch.jpg'),
  ...
  {
    image: require('../assets/img/index/info_portraits.jpg'),
  ...
  {
    image: require('../assets/img/index/info_gameplay.jpg'),
...
export const about = {
  ...
  avatarPath: (avatar: string) => require(`../assets/img/about/${avatar}_portrait.png`),
